...
write_order_to_json({'item': 'Принтер', 'quantity': 1, 'price': 250, 'buyer': 'Ivanovich', 'date': '02.03.2022'})
write_order_to_json({'item': 'Монитор', 'quantity': 1, 'price': 758, 'buyer': 'Ivanovich', 'date': '02.03.2022'})
